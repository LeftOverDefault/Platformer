...
class AnimationPlayer:
    def __init__( self, unique_identifier: Hashable, frames: list[pygame.Surface], duration: float ) -> None:
        self.animations = {}
        self.state = None
        self.frame_index = 0
    ...
    def add_animation( self, unique_identifier: Hashable, frames: list[ pygame.Surface ], duration: float ) -> None:
